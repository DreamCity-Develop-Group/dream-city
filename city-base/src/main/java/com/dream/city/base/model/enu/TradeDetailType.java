...
public enum TradeDetailType {
    ...
    USDT_INVEST_UNFREEZE("USDT_INVEST_FREEZE","usdt投资解冻"),
    ...
    TRANSFER_UNFREEZE_USDT("TRANSFER_UNFREEZE","转账审核不通过解冻USDT"),
    TRANSFER_UNFREEZE_MT("TRANSFER_UNFREEZE","转账审核不通过解冻MT"),
